...
<!-- header over -->
<link rel="stylesheet" type="text/css" href="/Public/css/new1.css" />
            ...
            <div class="mobile-navChil">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide kuai">
                        <!-- <span onclick="javascript:window.location.href='<?php echo U('Experience/index');?>'">产品体验</span> -->
                        <a href="<?php echo U('Experience/index');?>">产品体验</a>
                    </div>
                    <div class="swiper-slide">
                        <!-- <span onclick="javascript:window.location.href='<?php echo U('Experience/video');?>'">技术体验</span> -->
                        <a href="<?php echo U('Experience/video');?>">技术体验</a>
                    </div>
                </div>
...
<div class="main">
    <ul>
        <div id="list">    
            <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k; if(is_array($v)): $i = 0; $__LIST__ = $v;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><li <?php if($vv['sk']%3 == 0): ?>class="nor"<?php endif; ?>>
                        <div <?php if($k%2 == 0): ?>class="two"<?php endif; ?>>
                            <div class="imgs">
                                <a href="<?php echo U('Experience/detail');?>?pid=<?php echo ($vv["experience_id"]); ?>"><img src="<?php echo ($vv["imageUrl"]); ?>" alt="" /></a>
                            </div>
                            <div class="info">
                                <div class="info-bd">
                                  <a href="<?php echo U('Experience/detail');?>?pid=<?php echo ($vv["experience_id"]); ?>"><h5><?php echo ($vv["title"]); ?></h5></a>
                                   <!--  <span>
                                        <?php echo date('Y-m-d',$vv['showtime']);?>
                                    </span>
                                    <p><?php echo ($vv["info"]); ?></p> -->
                                    <a href="<?php echo U('Experience/detail');?>?pid=<?php echo ($vv["experience_id"]); ?>" class="more" pid=<?php echo ($vv["experience_id"]); ?>>READ MORE&gt;</a>
                                </div>
                            </div>
                        </div>
...
<script src="/Public/js/toggleClass.js"></script>
...
var su = 0;
    $('.lookMore').click(function(){
         $.get("<?php echo U('Experience/news_sub');?>",{su:su},function(data){
                    ...
                    for(var j in data) 
                    {
                        for (var i in data[j]) {
                           ...
                           html+='<div class="imgs"><a href="<?php echo U('Experience/detail');?>?pid='+data[j][i].experience_id+'"><img src="'+data[j][i].imageUrl+'" alt="" /></a></div>';
                           html+='<div class="info"><div class="info-bd"><a href="<?php echo U('Experience/detail');?>?pid='+data[j][i].experience_id+'">';
                           html+='<h5>'+data[j][i].title+'</h5></a>';

                           html+='<a href="<?php echo U('Experience/detail');?>?pid='+data[j][i].experience_id+'" class="more">READ MORE&gt;</a></div></div></div></li>';
