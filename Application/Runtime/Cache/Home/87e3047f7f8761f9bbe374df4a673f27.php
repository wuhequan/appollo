...
<!-- header over -->
<link rel="stylesheet" type="text/css" href="/Public/css/about-brand.css" />
<link rel="stylesheet" type="text/css" href="/Public/css/aboutAn.css" />
...
<div class="main">
    <div class="container">
       <?php echo (html_entity_decode($brand["content"])); ?>
    </div>
</div>
<!-- main over -->
<!-- Founder -->
<div class="founder">
    <div class="container">
        ...
        <span><img src="/Public/images/about/2.jpg" alt="" /></span>
        <p><img src="<?php echo ($brand["imageUrl2"]); ?>" alt="没找到图片" title="陈志雄先生"/></p>
    </div>
</div>
<!-- Founder over -->
<!-- service -->
<div class="service" style="background-image:url(/Public/images/about/bg.png)">
    <div class="container">
        <h5>Vensi威士丹利智能服务</h5>
        <span></span>
        <ul>
            <?php if(is_array($brand1)): $k = 0; $__LIST__ = $brand1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><li <?php if($k%4 == 0): ?>class="nor"<?php endif; ?>>
                    <div class="info">
                        <div class="dotted" style="background: url(<?php echo ($v["imageUrl"]); ?>) no-repeat center center;"></div>
...
<div class="programme">
    <div class="container">
        <h4>Vensi威士丹利智能主要技术方案</h4>
        <span></span>
        <ul>
            <?php if(is_array($brand2)): $k = 0; $__LIST__ = $brand2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><li <?php if($k%5 == 0): ?>class="nor"<?php endif; ?>>
                        <div class="icon">
                            <img src="<?php echo ($v["imageUrl"]); ?>" alt="" class="show" />
                            <img src="<?php echo ($v["imageUrl1"]); ?>" alt="" class="hide" />
                        </div>
...
<!-- programme over -->
<!-- Idea -->
<div class="idea" style="background-image:url(/Public/images/about/bg01.png)">
    <div class="container">
        <div class="info">
            <div class="left" style="background-image:url(<?php echo ($brand["imageUrl"]); ?>)"></div>
            <div class="right">
                <div class="cont">
                    <p><span>企业理念：</span><?php echo ($brand["idea"]); ?></p>

                    <p><span>企业使命：</span><?php echo ($brand["mission"]); ?></p>
                    <p><span>经营方针：</span><?php echo ($brand["policy"]); ?></p>
                    <p><span>公司愿景：</span><?php echo ($brand["vision"]); ?></p>

                    <p><span>企业核心竞争力：</span><?php echo ($brand["power"]); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<div class="core">
    <div class="container">
        ...
        <span></span>
        <ul>
            <?php if(is_array($brand3)): $k = 0; $__LIST__ = $brand3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><li <?php if($k%5 == 0): ?>class="nor"<?php endif; ?>>
                    <em><?php echo ($k); ?></em>
...
<div class="imgBox0">
    <div class="container">
        <?php echo (html_entity_decode($v["content1"])); ?>
        <br/>
