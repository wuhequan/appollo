...
<!-- login -->
<div class="login" style="background-image:url(/Public/images/login/bg.jpg)">
    <div class="login-bd">
        <div class="left">
            <form >
                <h5>用户登录</h5>
                <div class="baseW">
                    <input type="text" name="title" placeholder="账号"/>
                </div>                
                <div class="baseW">
...
<script type="text/javascript">
    $('form').submit(function(){
            ...
            $.post('<?php echo U("Vip/dologin");?>',data,function(data){
                if(data==0){
                  alert('登陆密码不正确');
                }
                if(data==2){
                ...
                if(data==1){
                    ...
                    window.location.href="<?php echo U("Vip/information");?>";
                }
                },'json')
            return false;
    })    
