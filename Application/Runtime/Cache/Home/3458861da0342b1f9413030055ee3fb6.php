        ...
        <div class="mobile-nav00">
            <div class="mobile-navChil">
                ...
                <div class="swiper-wrapper">
                    <?php if(is_array($classify)): $i = 0; $__LIST__ = $classify;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="swiper-slide <?php if(($_GET['pid']== $v[product_classify_id]) OR ($pre_pid == $v[product_classify_id])): ?>kuai<?php endif; ?>">
                        <!-- <span onclick="javascript:window.location.href='<?php echo U('Product/index');?>?pid=<?php echo ($v["product_classify_id"]); ?>'"><?php echo ($v["title"]); ?></span> -->
                            <a href="<?php echo U('Product/index');?>?pid=<?php echo ($v["product_classify_id"]); ?>"><?php echo ($v["title"]); ?></a>
                        </div><?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
...
<div class="product">
  <div id="list">   
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="list-box">
          <?php if(is_array($v)): $i = 0; $__LIST__ = $v;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Product/detail');?>?pid=<?php echo ($vv["product_id"]); ?>">       
                <div class="list">
                <div class="imgBox">
                    <img src="<?php echo ($vv["imageUrl"]); ?>" alt="" />
                </div>
                <div class="infos">
                    <h6><?php echo ($vv["title"]); ?></h6>
                    <p><?php echo ($vv["type"]); ?></p>
                </div>
                </div>  
...
var su = 0;
   ...
   $('.lookMore').click(function(){
         $.get("<?php echo U('Product/product_sub');?>",{su:su,pid:pid,pids:pids},function(data){
                    ...
                    for(var i in data) 
                    {
                       html+='<a href="<?php echo U('Product/detail');?>?pid='+data[i].product_id+'"><div class="list">';
