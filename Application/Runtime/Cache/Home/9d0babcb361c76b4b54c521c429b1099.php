...
<div class="main">
    <div class="container">
        <div class="top">
            <div class="left">
                <h5>客户服务</h5>
				<p>400&nbsp;电话：<span><?php echo ($data["phone"]); ?></span></p>
                <p>工作时间：<span><?php echo ($data["time"]); ?></span></p>
                
            </div>            
            <div class="left right">
                <h5>技术支持</h5>
               <p>咨询热线：<span><?php echo ($data["phone1"]); ?></span></p>
                <p>邮箱地址：<span><?php echo ($data["email"]); ?></span></p>
            </div>
        </div>
        <div class="bottom">
            <!-- map -->
            ...
            <div class="info">
                <h5>联系方式</h5>
                <p>广州市阿波罗智能科技有限公司</p>
                <p>咨询热线：<?php echo ($data["phone1"]); ?></p>
				<?php if(is_array($data["info"])): $k = 0; $__LIST__ = $data["info"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><p><?php if($k == 1): ?>加盟热线：<?php else: ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php endif; echo ($v); ?></p><?php endforeach; endif; else: echo "" ;endif; ?>
                <p>官网网址：<a href=""><?php echo ($data["website"]); ?></a></p>
