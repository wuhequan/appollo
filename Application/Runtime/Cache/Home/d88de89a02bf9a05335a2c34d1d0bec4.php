...
<div class="main">
    ...
    <ul class="history_list">
        ...
        <?php if(is_array($info)): $k = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><li>
                <span></span>
    ...
    <div class="img_more"></div>
</div>
<!-- mian over -->
<!--brand -->
<div class="brand">
    <div class="container">
            <h4><span>20</span>年深厚的品牌积淀</h4>
            <ul>
                <?php if(is_array($other["info"])): $k = 0; $__LIST__ = $other["info"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><li <?php if($k%6 == 0): ?>class="nor"<?php endif; ?>><p><?php echo (mb_substr($v,0,3,'utf8')); ?><br /><?php echo (mb_substr($v,3,10,'utf8')); ?></p></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
    </div>    
</div>
<!--brand over -->
