        ...
        <div id="list">    
            <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k; if(is_array($v)): $i = 0; $__LIST__ = $v;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><li <?php if($vv['sk']%3 == 0): ?>class="nor"<?php endif; ?>>
                        <div <?php if($k%2 == 0): ?>class="two"<?php endif; ?>>
                            <div class="imgs">
                                <a href="<?php echo U('About/culture_detail');?>?pid=<?php echo ($vv["culture_id"]); ?>"><img src="<?php echo ($vv["imageUrl"]); ?>" alt="" /></a>
                            </div>
                            <div class="info">
                                <div class="info-bd">
                                  <a href="<?php echo U('About/culture_detail');?>?pid=<?php echo ($vv["culture_id"]); ?>"><h5><?php echo ($vv["title"]); ?></h5></a>
                                   <!--  <span>
                                        <?php echo date('Y-m-d',$vv['showtime']);?>
                                    </span>
                                    <p><?php echo ($vv["info"]); ?></p> -->
                                    <a href="<?php echo U('About/culture_detail');?>?pid=<?php echo ($vv["culture_id"]); ?>" class="more" pid=<?php echo ($vv["culture_id"]); ?>>READ MORE&gt;</a>
                                </div>
                            </div>
                        </div>
...
var su = 0;
    $('.lookMore').click(function(){
         $.get("<?php echo U('About/news_sub');?>",{su:su},function(data){
                    ...
                    for(var j in data) 
                    {
                        for (var i in data[j]) {
                           ...
                           html+='<div class="imgs"><a href="<?php echo U('About/culture_detail');?>?pid='+data[j][i].culture_id+'"><img src="'+data[j][i].imageUrl+'" alt="" /></a></div>';
                           html+='<div class="info"><div class="info-bd"><a href="<?php echo U('About/culture_detail');?>?pid='+data[j][i].culture_id+'">';
                           html+='<h5>'+data[j][i].title+'</h5></a>';

                           html+='<a href="<?php echo U('About/culture_detail');?>?pid='+data[j][i].culture_id+'" class="more">READ MORE&gt;</a></div></div></div></li>';
