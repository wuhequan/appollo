        ...
        <div class="mobile-nav00">
            <div class="mobile-navChil">
                ...
                <div class="swiper-wrapper">
                    <?php if(is_array($classify)): $i = 0; $__LIST__ = $classify;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="swiper-slide <?php if($_GET['pid']== $v[news_classify_id]): ?>kuai<?php endif; ?>">
                            <a href="<?php echo U('News/index');?>?pid=<?php echo ($v["news_classify_id"]); ?>"><?php echo ($v["title"]); ?></a>
                        <!-- <span onclick="javascript:window.location.href='<?php echo U('News/index');?>?pid=<?php echo ($v["news_classify_id"]); ?>'"><?php echo ($v["title"]); ?></span> -->
                        </div><?php endforeach; endif; else: echo "" ;endif; ?>
                    <div class="swiper-slide">
                        <!-- <span onclick="javascript:window.location.href='<?php echo U('News/video1');?>'">公司视频</span> -->
                        <a href="<?php echo U('News/video1');?>">公司视频</a>
                    </div>
                </div>
        ...
        <div id="list">    
            <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k; if(is_array($v)): $i = 0; $__LIST__ = $v;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><li <?php if($vv['sk']%3 == 0): ?>class="nor"<?php endif; ?>>
                        <div <?php if($k%2 == 0): ?>class="two"<?php endif; ?>>
                            <div class="imgs">
                                <a href="<?php echo U('News/detail');?>?pid=<?php echo ($vv["news_id"]); ?>"><img src="<?php echo ($vv["imageUrl"]); ?>" alt="" /></a>
                            </div>
                            <div class="info">
                                <div class="info-bd">
                                  <a href="<?php echo U('News/detail');?>?pid=<?php echo ($vv["news_id"]); ?>"><h5><?php echo ($vv["title"]); ?></h5></a>
                                   <!--  <span>
                                        <?php echo date('Y-m-d',$vv['showtime']);?>
                                    </span>
                                    <p><?php echo ($vv["info"]); ?></p> -->
                                    <a href="<?php echo U('News/detail');?>?pid=<?php echo ($vv["news_id"]); ?>" class="more" pid=<?php echo ($vv["news_id"]); ?>>READ MORE&gt;</a>
                                </div>
                            </div>
                        </div>
...
var su = 0;
    ...
    $('.lookMore').click(function(){
         $.get("<?php echo U('News/news_sub');?>",{su:su,pid:pid},function(data){
                    ...
                    for(var j in data) 
                    {
                        for (var i in data[j]) {
                           ...
                           html+='<div class="imgs"><a href="<?php echo U('News/detail');?>?pid='+data[j][i].news_id+'"><img src="'+data[j][i].imageUrl+'" alt="" /></a></div>';
                           html+='<div class="info"><div class="info-bd"><a href="<?php echo U('News/detail');?>?pid='+data[j][i].news_id+'">';
                           html+='<h5>'+data[j][i].title+'</h5></a>';

                           html+='<a href="<?php echo U('News/detail');?>?pid='+data[j][i].news_id+'" class="more">READ MORE&gt;</a></div></div></div></li>';
