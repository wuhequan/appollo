						...
						<div class="row-fluid">
							<div class="portlet box blue">
								<div class="portlet-title">
									<div class="caption"><i class="icon-edit"></i>客户专区BANNER</div>
									<div class="tools">
								...
								<div class="portlet-body">
									<div class="btn-group">
										<button class="btn green" onclick="javascript:window.location.href='<?php echo U('Admin/Banner/vip_add');?>'">
										...
										<tbody>
											<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="" >
												...
												<td>
													...
													<input type="button" onclick="changeValue('#sort<?php echo ($key); ?>','banner_vip','banner_vip_id',<?php echo ($vo["banner_vip_id"]); ?>,'sort',$('#sort<?php echo ($key); ?>').val())" class="btn span2" value="修改" />
												</td>
												
												<td>
													<?php if($vo['status'] == 0): ?><a href="#" onclick="changeStatus(this,'banner_vip','banner_vip_id',<?php echo ($vo["banner_vip_id"]); ?>,'status',<?php echo ($vo['status']); ?>)" class="btn red icn-only"><i class="icon-remove-sign icon-white"></i></a>
													<?php else: ?>
														<a href="#" onclick="changeStatus(this,'banner_vip','banner_vip_id',<?php echo ($vo["banner_vip_id"]); ?>,'status',<?php echo ($vo['status']); ?>)" class="btn green icn-only"><i class="icon-ok-sign icon-white"></i></a><?php endif; ?>
												</td>
												<td><?php echo ($vo["createtime"]); ?></td>
												<td><?php echo ($vo["lastsavetime"]); ?></td>
												<td><a href="javascript:window.location.href='<?php echo U('Admin/Banner/vip_editor',array('id'=>$vo["banner_vip_id"],'action'=>'Banner','tpl'=>'vip_AE'));?>'">编辑</a></td>
												<td><a onclick="del(this,'banner_vip','banner_vip_id',<?php echo ($vo["banner_vip_id"]); ?>)">删除</a></td>
