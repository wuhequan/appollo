				...
				<div class="row-fluid">
						...
						<div class="row-fluid">
							...
							<div class="tab-pane active" >
								<div class="portlet box blue ">
									<div class="portlet-title">
										<div class="caption"><i class="icon-reorder"></i>招商加盟<input type="hidden" id="dataid" value="<?php echo ($data["join_id"]); ?>" /></div>
										<div class="tools">
							...
							<div class="portlet-body">
											<h3 class="form-section">在线加盟咨询列表</h3>
											<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
												...
												<tbody>
													<?php if(is_array($comment)): $i = 0; $__LIST__ = $comment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="" >
														<td><?php echo ($vo["comment_id"]); ?></td>
														<td><?php echo ($vo["user_name"]); ?></td>
														<td><?php echo ($vo["phone"]); ?></td>
													
														<td><?php echo ($vo["address"]); ?></td>
														<td style="width: 30%;"><a class="success" data-id=<?php echo ($vo["comment_id"]); ?> href="javascript:;" ><?php echo (mb_substr($vo["content"],0,20,'UTF8')); ?>...</a></td>
														<td><?php echo ($vo["createtime"]); ?></td>
														
														
														
														
														<td><a onclick="del(this,'comment','comment_id',<?php echo ($vo["comment_id"]); ?>)">删除</a></td>
									...
									<div class="row-fluid mainBtn">
										<?php echo ($pageShow); ?>
											...
											<div class="control-group">
												<label class="control-label">标题一</label>
												<div class="controls">
													<input type="text" placeholder="标题一" name="title" id="title" class="m-wrap large" value="<?php echo ($data["title"]); ?>">
													<span class="help-inline"></span>
												</div>
											</div>
											
											<div class="control-group">
												<label class="control-label">标题二</label>
												<div class="controls">
													<input type="text" placeholder="标题二" name="title1" id="title1" class="m-wrap large" value="<?php echo ($data["title1"]); ?>">
													<span class="help-inline"></span>
												</div>
											</div>
											
											<div class="control-group">
												<label class="control-label">十大优势图一</label>
												<div class="controls">
													...
													<span class="help-inline">图片比例 （500*560）</span>
												</div>
											</div>
											
											<div class="control-group">
												<label class="control-label">十大优势图二</label>
												<div class="controls">
													
													<img id="imageShow1" src="<?php echo ($data["imageUrl1"]); ?>" />
													<input type="hidden" id="imageUrl1" value="<?php echo ($data["imageUrl1"]); ?>" />
											...
											<div class="control-group">
												<label class="control-label">十大保障图</label>
												<div class="controls">
													
													<img id="imageShow2" src="<?php echo ($data["imageUrl2"]); ?>" />
													<input type="hidden" id="imageUrl2" value="<?php echo ($data["imageUrl2"]); ?>" />
													
														<div id="queue"></div>
														<input id="file_upload2" name="file_upload2" type="file" multiple="true">
													<span class="help-inline">图片比例 （1920*850）</span>
												</div>
											</div>
											
											<div class="control-group">
												<label class="control-label">加盟流程</label>
												<div class="controls">
													<textarea id="info" class="m-wrap span6" rows="6" ><?php echo ($data["info"]); ?></textarea>
													<span class="help-inline">每个流程用"|"分开</span>
												</div>
											</div>
											
											
											<div class="control-group">
												<label class="control-label">加盟案例</label>
												<div class="controls">
													<div id="maxShow">
													...
													<span class="help-inline" >图片比例 （260*140）</span>
...
<script type="text/javascript">
		...
		$(function(){
			$('.success').click(function(){
				...
				$("#myModal").modal({
					remote:"<?php echo U('Admin/join/comment');?>?comment_id="+id
				}).on('hidden', function () {
					history.go(0);
				});
			...
			setTimeout(imageObj.upload(),10);
		  	...
		  	var showEle1="imageShow1";
			var saveEle1="imageUrl1";
			var ele1="file_upload1";

			var imageObj1=new images(timestamp,token,swf,uploader,showEle1,saveEle1,ele1,"src");
			setTimeout(imageObj1.upload(),10);
			...
			var showEle2="imageShow2";
			var saveEle2="imageUrl2";
			var ele2="file_upload2";

			var imageObj2=new images(timestamp,token,swf,uploader,showEle2,saveEle2,ele2,"src");
			setTimeout(imageObj2.upload(),10);
	    ...
	    var maxUrl=saveImgs.join();
			...
			$.post(
				"<?php echo U('Admin/Join/join_Submit');?>",
				{
				...
				function(data){
					if(data==1){
		                success("<?php echo U('Admin/Join/join');?>");
					}else{
						errorNo();
					}
				}
