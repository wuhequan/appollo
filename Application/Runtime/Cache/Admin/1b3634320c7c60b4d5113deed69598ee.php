							...
							<div class="tab-pane active" >
								<div class="portlet box blue ">
									<div class="portlet-title">
										<div class="caption"><i class="icon-reorder"></i>体验与创新BANNER<input type="hidden" id="dataid" value="<?php echo ($data["banner_experience_id"]); ?>" /></div>
										<div class="tools">
...
<!-- BEGIN FOOTER -->
	...
	<script type="text/javascript">
		...
		function submitClick(){
			...
			$.post(
				"<?php echo U('Admin/Banner/experience_submit');?>",
				{
					'dataid':$("#dataid").val(),
					'url':$("#url").val(),
				...
				function(data){
					if(data==1){
		                success("<?php echo U('Admin/Banner/experience');?>");
					}else{
						errorNo();
					}
				}
