							...
							<div class="tab-pane active" >
								<div class="portlet box blue ">
									<div class="portlet-title">
										<div class="caption"><i class="icon-reorder"></i>荣誉资质<input type="hidden" id="dataid" value="<?php echo ($data["honor_id"]); ?>" /></div>
										<div class="tools">
										...
										<form action="#" class="form-horizontal form-bordered">
											...
											<div class="control-group">
												...
												<div class="controls">
													...
													<span class="help-inline">图片比例 （735*488）</span>
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" placeholder="Title" name="获奖年份" id="year" class="m-wrap large" value="<?php echo ($data["year"]); ?>">
...
<!-- BEGIN FOOTER -->
	...
	<script type="text/javascript">
		...
		function submitClick(){
			...
			$.post(
				"<?php echo U('Admin/About/honor_Submit');?>",
				{
					'dataid':$("#dataid").val(),
				...
				function(data){
					if(data==1){
		                success("<?php echo U('Admin/About/honor');?>");
					}else{
						errorNo();
					}
				}
