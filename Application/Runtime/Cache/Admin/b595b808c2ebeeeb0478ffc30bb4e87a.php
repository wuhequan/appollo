						...
						<div class="row-fluid">
							...
							<div class="portlet">
								<div class="portlet-title">
									<div class="caption"><i class="icon-cogs"></i>系统参数</div>
									<div class="tools">
								...
								<div class="portlet-body">
									<table class="table table-striped table-bordered table-advance table-hover">
										...
										<tbody>
											<tr>
												<td>操作系统</td>
												<td><?php echo ($info["info1"]); ?></td>
												<td>运行环境</td>
												<td><?php echo ($info["info2"]); ?></td>
											</tr>
											<tr>
												<td>PHP运行方式</td>
												<td><?php echo ($info["info3"]); ?></td>
												<td>ThinkPHP版本</td>
												<td><?php echo ($info["info4"]); ?></td>
											</tr>
											<tr>
												<td>上传附件限制</td>
												<td><?php echo ($info["info5"]); ?></td>
												<td>执行时间限制</td>
												<td><?php echo ($info["info6"]); ?></td>
											</tr>
											<tr>
												<td>服务器时间</td>
												<td><?php echo ($info["info7"]); ?></td>
												<td>北京时间</td>
												<td><?php echo ($info["info8"]); ?></td>
											</tr>
											<tr>
												<td>服务器域名/IP</td>
												<td><?php echo ($info["info9"]); ?></td>
												<td>剩余空间</td>
												<td><?php echo ($info["info10"]); ?></td>
											</tr>
											<tr>
												<td>register_globals</td>
												<td><?php echo ($info["info11"]); ?></td>
												<td>magic_quotes_gpc</td>
												<td><?php echo ($info["info12"]); ?></td>
											</tr>
											<tr>
												<td>magic_quotes_runtime</td>
												<td><?php echo ($info["info13"]); ?></td>
												<td></td>
												<td></td>
											</tr>
										</tbody>
