							...
							<div class="tab-pane active" >
								<div class="portlet box blue ">
									<div class="portlet-title">
										<div class="caption"><i class="icon-reorder"></i>品牌介绍<input type="hidden" id="dataid" value="<?php echo ($data["brand_id"]); ?>" /></div>
										<div class="tools">
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" placeholder="英文标题" name="etitle" id="etitle" class="m-wrap large" value="<?php echo ($data["etitle"]); ?>">
													<span class="help-inline"></span>
												</div>
											</div>
 -->
											<div class="control-group">
												<label class="control-label">图一</label>
												<div class="controls">
													...
													<span class="help-inline">图片比例 （1200*500）</span>
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													...
													<span class="help-inline">图片比例 （600*420）</span>
												</div>
											</div>

											<div class="control-group">
												<label class="control-label">企业理念</label>
												<div class="controls">
													<input type="text" placeholder="企业理念" name="idea" id="idea" class="m-wrap large" value="<?php echo ($data["idea"]); ?>">
													<span class="help-inline"></span>
												</div>
											</div>

											<div class="control-group">
												<label class="control-label">企业使命</label>
												<div class="controls">
													<input type="text" placeholder="企业使命" name="mission" id="mission" class="m-wrap large" value="<?php echo ($data["mission"]); ?>">
													<span class="help-inline"></span>
												</div>
											</div>

											<div class="control-group">
												<label class="control-label">经营方针</label>
												<div class="controls">
													<input type="text" placeholder="经营方针" name="policy" id="policy" class="m-wrap large" value="<?php echo ($data["policy"]); ?>">
													<span class="help-inline"></span>
												</div>
											</div>

											<div class="control-group">
												<label class="control-label">公司愿景</label>
												<div class="controls">
													<input type="text" placeholder="公司愿景" name="vision" id="vision" class="m-wrap large" value="<?php echo ($data["vision"]); ?>">
													<span class="help-inline"></span>
												</div>
											</div>

											<div class="control-group">
												<label class="control-label">企业核心竞争力</label>
												<div class="controls">
													<input type="text" placeholder="企业核心竞争力" name="power" id="power" class="m-wrap large" value="<?php echo ($data["power"]); ?>">
													<span class="help-inline"></span>
												</div>
											</div>

											<div class="control-group">
												<label class="control-label">底部内容(可加可不加)</label>
												<div class="controls">
													<textarea cols="80" name="content1" rows="10"><?php echo ($data["content1"]); ?></textarea>
												</div>
											</div>
...
var editorObj1=new editor("/Public","content1");
		function submitClick(){
			var content=editorObj.editor.getData();
			var content1=editorObj1.editor.getData();
			$.post(
				"<?php echo U('Admin/About/brand_Submit');?>",
				{
				...
				function(data){
					if(data==1){
		                success("<?php echo U('Admin/About/brand');?>");
					}else{
						errorNo();
					}
				}
