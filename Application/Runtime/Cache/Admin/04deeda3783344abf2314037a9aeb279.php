							...
							<div class="tab-pane active" >
								<div class="portlet box blue ">
									<div class="portlet-title">
										<div class="caption"><i class="icon-reorder"></i>技术体验<input type="hidden" id="dataid" value="<?php echo ($data["video_id"]); ?>" /></div>
										<div class="tools">
...
<!-- BEGIN FOOTER -->
	...
	<script type="text/javascript">
		...
		function submitClick(){
			...
			$.post(
				"<?php echo U('Admin/Experience/video_Submit');?>",
				{
					'dataid':$("#dataid").val(),
				...
				function(data){
					if(data==1){
		                success("<?php echo U('Admin/Experience/video');?>");
					}else{
						errorNo();
					}
				}
