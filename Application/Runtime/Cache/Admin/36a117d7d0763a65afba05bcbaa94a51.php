							...
							<div class="tab-pane active" >
								<div class="portlet box blue ">
									<div class="portlet-title">
										<div class="caption"><i class="icon-reorder"></i>光辉历程<input type="hidden" id="dataid" value="<?php echo ($data["info_id"]); ?>" /></div>
										<div class="tools">
										...
										<form action="#" class="form-horizontal form-bordered">
											...
											<!-- <div class="control-group">
												...
												<div class="controls">
													...
													<span class="help-inline" style="color:red">图片比例 （1020*460）</span>
												</div>
											</div>
 -->
...
<!-- BEGIN FOOTER -->
	...
	<script type="text/javascript">
		...
		function submitClick(){
			...
			$.post(
				"<?php echo U('Admin/About/info_Submit');?>",
				{
					'dataid':$("#dataid").val(),
