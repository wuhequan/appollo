							...
							<div class="tab-pane active" >
								<div class="portlet box blue ">
									<div class="portlet-title">
										<div class="caption"><i class="icon-reorder"></i>新闻<input type="hidden" id="dataid" value="<?php echo ($data["news_id"]); ?>" /></div>
										<div class="tools">
...
<!-- BEGIN FOOTER -->
	...
	<script type="text/javascript">
		...
		function submitClick(){
			...
			$.post(
				"<?php echo U('Admin/Press/index_Submit');?>",
				{
					'dataid':$("#dataid").val(),
					...
					'author':$("#author").val(),
					'news_classify_id':$('#classify option:selected') .val(),


				},
				function(data){
					if(data==1){
		                success("<?php echo U('Admin/Press/index');?>");
					}else{
						errorNo();
					}
				}
