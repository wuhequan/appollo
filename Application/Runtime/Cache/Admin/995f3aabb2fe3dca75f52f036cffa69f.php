						...
						<div class="row-fluid">
							<div class="portlet box blue">
								...
								<div class="portlet-body">
									<div class="btn-group">
										<button class="btn green" onclick="javascript:window.location.href='<?php echo U('Admin/About/video_add');?>'">
									...
									<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
										...
										<tbody>
											<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="" >
												...
												<td><a href="javascript:window.location.href='<?php echo U('Admin/About/video_editor',array('id'=>$vo["video_id"],'action'=>'Paper','tpl'=>'index_AE'));?>'">编辑</a></td>
