						...
						<div class="row-fluid">
							<div class="portlet box blue">
								<div class="portlet-title">
									<div class="caption"><i class="icon-edit"></i>智能服务</div>
									<div class="tools">
								...
								<div class="portlet-body">
									<div class="btn-group">
										<button class="btn green" onclick="javascript:window.location.href='<?php echo U('Admin/About/brand1_add');?>'">
										...
										<tbody>
											<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="" >
												...
												<td>
													...
													<input type="button" onclick="changeValue('#sort<?php echo ($key); ?>','brand1','brand1_id',<?php echo ($vo["brand1_id"]); ?>,'sort',$('#sort<?php echo ($key); ?>').val())" class="btn span2" value="修改" />
												</td>
												
												<td>
													<?php if($vo['status'] == 0): ?><a href="javascript:;" onclick="changeStatus(this,'brand1','brand1_id',<?php echo ($vo["brand1_id"]); ?>,'status',<?php echo ($vo['status']); ?>)" class="btn red icn-only"><i class="icon-remove-sign icon-white"></i></a>
													<?php else: ?>
														<a href="javascript:;" onclick="changeStatus(this,'brand1','brand1_id',<?php echo ($vo["brand1_id"]); ?>,'status',<?php echo ($vo['status']); ?>)" class="btn green icn-only"><i class="icon-ok-sign icon-white"></i></a><?php endif; ?>
												</td>
												<td><a href="javascript:window.location.href='<?php echo U('Admin/About/brand1_editor',array('id'=>$vo["brand1_id"],'action'=>'Paper','tpl'=>'index_AE'));?>'">编辑</a></td>
												<td><a onclick="del(this,'brand1','brand1_id',<?php echo ($vo["brand1_id"]); ?>)">删除</a></td>
