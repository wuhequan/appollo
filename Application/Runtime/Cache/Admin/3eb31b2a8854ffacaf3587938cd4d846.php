							...
							<div class="tab-pane active" >
								<div class="portlet box blue ">
									<div class="portlet-title">
										<div class="caption"><i class="icon-reorder"></i>智能服务<input type="hidden" id="dataid" value="<?php echo ($data["brand1_id"]); ?>" /></div>
										<div class="tools">
...
<!-- BEGIN FOOTER -->
	...
	<script type="text/javascript">
		...
		function submitClick(){
			...
			$.post(
				"<?php echo U('Admin/About/brand1_Submit');?>",
				{
					'dataid':$("#dataid").val(),
				...
				function(data){
					if(data==1){
		                success("<?php echo U('Admin/About/brand1');?>");
					}else{
						errorNo();
					}
				}
