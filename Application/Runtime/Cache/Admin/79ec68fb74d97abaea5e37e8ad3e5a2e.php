							...
							<div class="tab-pane active" >
								<div class="portlet box blue ">
									<div class="portlet-title">
										<div class="caption"><i class="icon-reorder"></i>企业文化<input type="hidden" id="dataid" value="<?php echo ($data["culture_id"]); ?>" /></div>
										<div class="tools">
										...
										<form action="#" class="form-horizontal form-bordered">
											...
											<div class="control-group">
												...
												<div class="controls">
													...
													<span class="help-inline">图片比例 （1000*640）</span>
												</div>
											</div>
											...
											<div class="control-group">
												<label class="control-label">详情页内容</label>
												<div class="controls">
...
<!-- BEGIN FOOTER -->
	...
	<script type="text/javascript">
		...
		function submitClick(){
			...
			$.post(
				"<?php echo U('Admin/About/culture_Submit');?>",
				{
					'dataid':$("#dataid").val(),
				...
				function(data){
					if(data==1){
		                success("<?php echo U('Admin/About/culture');?>");
					}else{
						errorNo();
					}
				}
