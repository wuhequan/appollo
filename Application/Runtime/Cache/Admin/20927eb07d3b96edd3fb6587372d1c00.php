						...
						<div class="row-fluid">
								...
								<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption"><i class="icon-comments"></i>权限分配<input type="hidden" id="dataid" value="<?php echo ($admin["admin_id"]); ?>" /></div>
										<div class="tools">
											...
											<ol class="dd-list">
												<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="dd-item dd3-item" data-id="<?php echo ($vo["nav_left_id"]); ?>">
														...
														<div class="dd3-content">
															...
															<span class=""><input type="checkbox" class="inputCheckbox inputCheckbox<?php echo ($vo["nav_left_id"]); ?>F inputCheckboxF" <?php if($vo['checkbox'] == 1): ?>checked<?php endif; ?> value="<?php echo ($vo["nav_left_id"]); ?>"></span>
														</div>
														<ol class="dd-list">
															<?php if(is_array($vo['child'])): $j = 0; $__LIST__ = $vo['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($j % 2 );++$j;?><li class="dd-item dd3-item" data-id="17">
																	...
																	<div class="dd3-content">
																		...
																		<span class=""><input type="checkbox" class="inputCheckbox inputCheckbox<?php echo ($vo1["nav_left_id"]); ?>" value="<?php echo ($vo1["nav_left_id"]); ?>" <?php if($vo1['checkbox'] == 1): ?>checked<?php endif; ?>></span>
																	</div>
																	<ol class="dd-list">
																		<?php if(is_array($vo1['child'])): $k = 0; $__LIST__ = $vo1['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($k % 2 );++$k;?><li class="dd-item dd3-item" data-id="17">
																				...
																				<div class="dd3-content">
																					...
																					<span class=""><input type="checkbox" class="inputCheckbox inputCheckbox<?php echo ($vo2["nav_left_id"]); ?>" value="<?php echo ($vo2["nav_left_id"]); ?>" <?php if($vo2['checkbox'] == 1): ?>checked<?php endif; ?>></span>
																				</div>
																				<ol class="dd-list">
																				</ol>
																			</li><?php endforeach; endif; else: echo "" ;endif; ?>
...
<!-- BEGIN FOOTER -->
	...
	<script>
		...
		function submitClick(){
			...
			$.post(
				"<?php echo U('Admin/Admin/role_Submit');?>",
				{
					'dataid':$("#dataid").val(),
					'role':role
				},
				function(data){
					if(data==1){
		                success("<?php echo U('Admin/Admin/admin');?>");
					}else{
						errorNo();
					}
				}
