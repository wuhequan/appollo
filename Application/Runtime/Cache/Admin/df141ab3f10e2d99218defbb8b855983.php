							...
							<div class="tab-pane active" >
								<div class="portlet box blue ">
									<div class="portlet-title">
										<div class="caption"><i class="icon-reorder"></i>产品体验<input type="hidden" id="dataid" value="<?php echo ($data["experience_id"]); ?>" /></div>
										<div class="tools">
										...
										<form action="#" class="form-horizontal form-bordered">
											...
											<div class="control-group">
												...
												<div class="controls">
													...
													<span class="help-inline">图片比例 （490*252）</span>
												</div>
											</div>
...
<!-- BEGIN FOOTER -->
	...
	<script type="text/javascript">
		...
		function submitClick(){
			...
			$.post(
				"<?php echo U('Admin/Experience/product_Submit');?>",
				{
					'dataid':$("#dataid").val(),
					...
					'author':$("#author").val(),
					'experience_classify_id':$('#classify option:selected') .val(),


				},
				function(data){
					if(data==1){
		                success("<?php echo U('Admin/Experience/product');?>");
					}else{
						errorNo();
					}
				}
