						...
						<div class="row-fluid">
							<div class="portlet box blue">
								<div class="portlet-title">
									<div class="caption"><i class="icon-edit"></i>产品体验</div>
									<div class="tools">
								...
								<div class="portlet-body">
									<div class="btn-group">
										<button class="btn green" onclick="javascript:window.location.href='<?php echo U('Admin/Experience/product_add');?>'">
										添加 <i class="icon-plus"></i>
										</button>
										<button class="btn " onclick="javascript:window.location.href='<?php echo U('Admin/Experience/product',array('showindex'=>1));?>'">
										 筛选推优
										</button>
									</div>
									<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
										...
										<tbody>
											<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="" >
												<td><?php echo ($vo["experience_id"]); ?></td>
												...
												<td>
													...
													<input type="button" onclick="changeValue('#sort<?php echo ($key); ?>','experience','experience_id',<?php echo ($vo["experience_id"]); ?>,'sort',$('#sort<?php echo ($key); ?>').val())" class="btn span2" value="修改" />
												</td>
												
												<td>
													<?php if($vo['status'] == 0): ?><a href="javascript:;" onclick="changeStatus(this,'experience','experience_id',<?php echo ($vo["experience_id"]); ?>,'status',<?php echo ($vo['status']); ?>)" class="btn red icn-only"><i class="icon-remove-sign icon-white"></i></a>
													<?php else: ?>
														<a href="javascript:;" onclick="changeStatus(this,'experience','experience_id',<?php echo ($vo["experience_id"]); ?>,'status',<?php echo ($vo['status']); ?>)" class="btn green icn-only"><i class="icon-ok-sign icon-white"></i></a><?php endif; ?>
												</td>
												
												<td>
													<?php if($vo['showindex'] == 0): ?><a href="javascript:;" onclick="changeStatus(this,'experience','experience_id',<?php echo ($vo["experience_id"]); ?>,'showindex',<?php echo ($vo['showindex']); ?>)" class="btn red icn-only"><i class="icon-remove-sign icon-white"></i></a>
													<?php else: ?>
														<a href="javascript:;" onclick="changeStatus(this,'experience','experience_id',<?php echo ($vo["experience_id"]); ?>,'showindex',<?php echo ($vo['showindex']); ?>)" class="btn green icn-only"><i class="icon-ok-sign icon-white"></i></a><?php endif; ?>
												</td>

											

												<td><a href="javascript:window.location.href='<?php echo U('Admin/Press/index_editor',array('id'=>$vo["experience_id"],'action'=>'Paper','tpl'=>'index_AE'));?>'">编辑</a></td>
												<td><a onclick="del(this,'experience','experience_id',<?php echo ($vo["experience_id"]); ?>)">删除</a></td>
