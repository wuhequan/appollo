$(function(){
$('.show .big ul li').eq(0).show()  
    $('.show .small .child').click(function(){  
        var index =$(this).index();
        $('.show .big ul li').eq(index).fadeIn(500).siblings().fadeOut(500)

    })

})
/*banner*/
var banner01=new change();

    banner01.position=function(){
        change().position.call(this);
        if(this.data["position_style"]=="banner01"){
    ...
    banner01.todo=function(data){
        ...
        if(this.data["position_style"]=="banner01"){
            ...
            $(this.data["element"]+":eq("+this.data["index"]+")").stop(false,true).addClass("in").css({"left":-direc*this.data["position_width"]+"px"}).animate({"left":"0px"},500,function(){banner01.data["todo_bool"]=false;});
            
        }
    }
    banner01.init({
        "parent_move_element":".banner01",
        "element":".banner01 .content01",
        "position_style":"banner01",
        "autoplay":true,
        "autoplay_time":3000,
        "btn":'<div class="child01"></div>',
        "btn_function":"banner01",
        "btn_parent":".banner01 .banner-nav"
    });
/*
*   by dong
*   http://www.dydong.com 
