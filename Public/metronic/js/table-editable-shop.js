    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[6].innerHTML = '<input type="text" disabled="false" class="m-wrap small" value="' + aData[6] + '">';
            ...
            function saveRow(oTable, nRow) {
                ...
                $.post(
                    '/Admin/Shop/submit.html',
                    {
                        'shop_id':jqInputs[0].value,
                        'shop_name':jqInputs[2].value,
                        'shop_logo':jqInputs[3].value,
                        'shop_info':jqInputs[4].value,
            ...
            var oTable = $('#sample_editable_1').dataTable({
                "aLengthMenu": [
                    [5, 15, 20, 40,80,100,-1],
                    [5, 15, 20,40,80,100, "All"] // change per page values here
                ],
