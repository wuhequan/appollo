    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[7].innerHTML = '<input type="text" disabled="false" class="m-wrap small" value="' + aData[7] + '">';
            ...
            function saveRow(oTable, nRow) {
                ...
                $.post(
                    '/Admin/Goods/submit.html',
                    {
                        'goods_id':jqInputs[0].value,
                        'goods_price':jqInputs[3].value,
                        'goods_title':jqInputs[2].value,
                        'goods_info':jqInputs[4].value,
                        'goods_img':jqInputs[5].value,
